...
export function AnimatedBeamMultipleOutputDemo({className,}) {
    ...
    let key = 0;
    const fromCircles = [
        [<Icons.googleDrive/>, div1Ref, key++, "Google Drive"],
        [<Icons.googleDocs/>, div2Ref, key++, "Google Docs"],
        [<Icons.whatsapp/>, div3Ref, key++, "WhatsApp"],
        [<Icons.messenger/>, div4Ref, key++, "Messenger"],
        [<Icons.notion/>, div5Ref, key++, "Notion"],
    ]
            ...
            <div className="flex z-10 size-full flex-row items-stretch justify-between gap-10 max-w-lg">
                <div className="flex flex-col justify-center gap-2">
                    ...
                    {fromCircles.map(circle => {
                        const [Icon, ref, key, text] = circle;
                        return (
                            <Tooltip key={key}>
...
export const Icons = {
    notion: () => (
        <svg xmlns="http://www.w3.org/2000/svg" width={50} height={50} viewBox="0 0 24 24">
            <path fill="#57beff" d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8zm-3.06 16L7.4 14.46l1.41-1.41l2.12 2.12l4.24-4.24l1.41 1.41zM13 9V3.5L18.5 9z"></path>
        </svg>
    ),
    openai: () => (
        <svg
    ...
    justdoList: () => <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" viewBox="0 0 473 512">

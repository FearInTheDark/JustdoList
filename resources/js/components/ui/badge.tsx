...
const badgeVariants = cva(
    "inline-flex items-center font-inter rounded-md border ml-1 px-2 py-0.2 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
    {
        variants: {
            variant: {
                default:

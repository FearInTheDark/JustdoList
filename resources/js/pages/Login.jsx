                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                {errors.email ?
                                    <span className="text-sm text-rose-500 italic dark:text-rose-400">{errors.email}</span> : ''}
                            </div>
                        </div>
                        ...
                        <Button type="submit" className="w-full dark:bg-primary-600 dark:hover:bg-primary-700 dark:text-black" disabled={processing}>
                            {processing &&
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="animate-spin mr-2">

                ...
                <div className="py-12 md:py-20">
                    ...
                    <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
                        <h2 className="text-3xl font-bold text-gray-200 md:text-4xl"
                            data-aos="zoom-y-out"
                        >
                            JustdoList helps you to focus on your work and get more done.
                        </h2>
                    </div>
                    {/*  Beam*/}
                    <AnimatedBeamMultipleOutputDemo className="bg-inherit border-none"/>
                    {/* Grid */}
                    <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
                        ...
                        <article data-aos="fade-down">
                            <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                                ...
                                <span>Task Managing</span>
                            </h3>
                            <p className="text-[15px] text-gray-400">
                                Smartly organize your tasks, track your progress, and collaborate.
                            </p>
                        </article>
                        <article data-aos="fade-down-left">
                            <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                                ...
                                <span>SSR &amp; Performance</span>
                            </h3>
                            <p className="text-[15px] text-gray-400">
                                Improve your site performance with server-side rendering and
                                faster load times.
                            </p>
                        </article>
                        <article data-aos="fade-up-right">
                            ...
                            <p className="text-[15px] text-gray-400">
                                Customize the look and feel of your site with custom themes
                                and styles.
                            </p>
                        </article>
                        <article data-aos="fade-up">
                            ...
                            <p className="text-[15px] text-gray-400">
                                Group your tasks into lists and boards to stay organized and
                        ...
                        <article data-aos="fade-up-left">
                            ...
                            <p className="text-[15px] text-gray-400">
                                Collect feedback from your users and customers to improve your
                                site and products.
                            </p>
                        </article>
                    </div>
